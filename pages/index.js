...
const topRowStyle = (isMobile = false) => ({
  ...
  marginBottom: 24,
  minHeight: 0,
  height: isMobile ? 'auto' : '280px' // Уменьшена высота для соответствия реальному содержимому
});
...
export default function Home() {
  ...
  return (
    <main style={container}>
      ...
      <header style={header}>
        <h1 style={{ fontSize: 28, margin: 0, fontWeight: 600 }}>📊 NLP Data Analytics</h1>
      ...
      <div style={topRowStyle(isMobile)}>
        ...
        <section style={section}>
          <h2 style={{ marginTop: 0, marginBottom: 12, flexShrink: 0, fontSize: 18, fontWeight: 600 }}>📁 Загрузка данных</h2>
        ...
        <section style={section}>
          <h2 style={{ marginTop: 0, marginBottom: 12, flexShrink: 0, fontSize: 18, fontWeight: 600 }}>💬 Задайте вопрос</h2>
          <div style={sectionContent}>
            <ChatInterface 
              query={query}
        ...
        <section style={section}>
          <h2 style={{ marginTop: 0, marginBottom: 12, flexShrink: 0, fontSize: 18, fontWeight: 600 }}>📝 Логи обработки</h2>
          <div style={sectionContent}>
            {logs.length > 0 ? (
              <div style={{
                fontFamily: 'monospace',
      ...
      {(results && (results.chart || results.table)) && (
        <section style={{ ...section, marginBottom: 24 }}>
          <h2 style={{ marginTop: 0, marginBottom: 12, fontSize: 18, fontWeight: 600 }}>📊 Результаты анализа</h2>
          {loading && (
          ...
          {!loading && results.chart && (
            <div style={{ marginBottom: 24 }}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12 }}>
                <h3 style={{ marginTop: 0, marginBottom: 0, fontSize: 15, color: '#f8fafc', fontWeight: 600 }}>📈 Визуализация</h3>
                <button
          ...
          {!loading && results.table && (
            <div>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 12, flexWrap: 'wrap', gap: 8 }}>
                <h3 style={{ marginTop: 0, marginBottom: 0, fontSize: 15, color: '#f8fafc', fontWeight: 600 }}>📋 Данные</h3>
      ...
      {results && results.message && (
        <section style={section}>
          <h2 style={{ marginTop: 0, marginBottom: 12, fontSize: 18, fontWeight: 600 }}>💬 Ответ от LLM</h2>
          <div style={{
